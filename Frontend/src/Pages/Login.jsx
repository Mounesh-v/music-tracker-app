    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 md:px-6 py-8 md:py-12">
      ...
      >
        <div className="flex flex-col items-center mb-6 md:mb-8">
          ...
          <h1 className="font-display text-xl md:text-2xl font-bold text-white">Welcome back</h1>
          <p className="text-sm text-[#9CA3AF] mt-1">Sign in to continue vibing</p>
        </div>
        ...
        <p className="text-center text-sm text-[#9CA3AF] mt-6">
          ...
          <Link to="/signup" className="text-[#5FD0B3] hover:underline font-medium">
            Sign up
          </Link>
        </p>
      </div>
